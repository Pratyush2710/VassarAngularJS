(function() {
  ...
  angular
    ...
    .controller('vassarLabsController', function($scope, $mdSidenav, $mdDialog, $mdToast, classifiedsFactory) {
      ...
      $scope.openSidebar = function() {
        $scope.sidebarTitle = 'Add an Intern';
        $mdSidenav('left').open();
      }
      ...
      $scope.saveClassified = function(classified) {
        if(classified) {
          ...
          $scope.classified = {};
          $scope.closeSidebar();
          showToast('Intern added');
        }
      }

      $scope.editClassified = function(classified) {
        $scope.editing = true;
        $scope.sidebarTitle = 'Edit Details';
